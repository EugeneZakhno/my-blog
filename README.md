# my_blogging serverless API
The my_blogging project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=my_blogging -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot-archetype -DarchetypeVersion=1.4 -DgroupId=org.example -Dversion=1.0-SNAPSHOT -Dinteractive=false
$ cd my_blogging
$ mvn clean package
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "My_bloggingApi",
                    "OutputKey": "My_bloggingApi",
